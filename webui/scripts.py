...
SCRIPTS = [
    # ---------------------------------------------------------------- 主流程
    {
        ...
        "args": [
            ...
            {"flag": "--outlook-engine", "type": "choice", "choices": ["ruoyi", "camonfox", "standalone"],
             "default": "ruoyi", "help": "Outlook 自注册后端"},
            {"flag": "--outlook-proxy-file", "type": "str", "default": "proxies_outlook.txt",
             "help": "ruoyi/camonfox 后端代理池文件"},
            {"flag": "--outlook-proxy-source", "type": "choice", "default": "file",
             "choices": [
                 {"label": "本地代理文件", "value": "file"},
                 {"label": "Aimili 随机接口", "value": "aimili-random"},
                 {"label": "Aimili 列表接口", "value": "aimili-list"},
             ],
             "help": "ruoyi 代理来源；随机=每号请求 random URL，列表=请求列表 URL 后本地随机"},
            ...
            {"flag": "--outlook-headless", "type": "bool", "default": False,
             "help": "ruoyi/camonfox 后端：Outlook 注册阶段使用无头模式"},
    ...
    },
    {
        ...
        "args": [
            {"flag": "--count", "type": "int", "default": 1, "help": "注册数量"},
            {"flag": "--concurrency", "type": "int", "default": 1, "help": "并发注册数"},
            {"flag": "--proxy-source", "type": "choice", "default": "file",
             ...
             "help": "代理来源；随机=每号请求 random URL，列表=请求列表 URL 后本地随机"},
    ...
    {
        "id": "register_outlook_camonfox",
        "file": "register_outlook_camonfox.py",
        "category": "养号/邮箱",
        "title": "Outlook 自注册(camonfox)",
        "desc": "原生 Camoufox(sync_api) 版 Outlook 自注册；独立截图/输出，支持 SOCKS5 代理池、验证码按住、Graph token 落盘。",
        "args": [
            {"flag": "--count", "type": "int", "default": 1, "help": "注册数量"},
            {"flag": "--proxy-source", "type": "choice", "default": "file",
             "choices": [
                 {"label": "代理文件", "value": "file"},
                 {"label": "代理地址", "value": "ip"},
             ],
             "help": "选择代理来源：代理文件或单条代理地址"},
            {"flag": "--proxy-file", "type": "str", "default": "proxies_outlook.txt", "help": "代理池文件(每行一个 user:pass@host:port)"},
            {"flag": "--proxy-ip", "type": "str", "default": "",
             "help": "单条代理地址，如 http://user:pass@host:port；选择“代理地址”时使用"},
            {"flag": "--timeout", "type": "int", "default": 300, "help": "单号超时(秒)"},
            {"flag": "--max-press", "type": "str", "default": "5", "help": "验证码按住次数上限"},
            {"flag": "--headless", "type": "bool", "default": False, "help": "无头模式"},
            {"flag": "--px-press-screenshots", "type": "bool", "default": False,
...
ENV_SCHEMA = [
    ...
    {"group": "指纹浏览器", "tests": [{"target": "bitbrowser", "label": "测试 指纹浏览器连通"}], "items": [
        ...
        {"key": "OUTLOOK_CAMONFOX_GEOIP", "default": "1",
         "help": "Outlook 自注册(camonfox) 原生 Camoufox 是否按代理出口 IP 对齐 geoip：1 开启，0 关闭"},
        {"key": "OUTLOOK_CAMONFOX_LOCALE", "default": "en-US",
         "help": "Camoufox 页面语言/locale；默认 en-US 保持英文页面，国家/地区仍可按 OUTLOOK_CAMONFOX_COUNTRY 选择"},
        {"key": "OUTLOOK_CAMONFOX_COUNTRY", "default": "keep",
         "help": "camonfox 生日页国家/地区；keep=不切换，保留页面默认值"},
    ]},
    ...
    {"group": "Outlook 邮箱来源", "items": [
        ...
        {"key": "OUTLOOK_RUOYI_PROXY_SOURCE", "type": "choice", "choices": ["file", "aimili-random", "aimili-list"],
         "default": "file", "help": "ruoyi 代理来源：file 本地文件，aimili-random 每号远端随机，aimili-list 请求列表 URL 后本地随机"},
