...
SCRIPTS = [
    ...
    },
    {
        ...
        "category": "养号/邮箱",
        "title": "解锁被锁 Outlook",
        "desc": "批量解锁被锁账号(BitBrowser 版)，结果分类输出到 unlock_results/。",
        "args": [
    ...
    },
    {
        ...
        "desc": "ruyipage 定制 Firefox + ruoyi 按住滑块状态机解锁被锁账号；代理走 --proxy-url 池(同注册)。结果分类输出到 unlock_results/。",
        "args": [
            {"flag": "--input", "type": "str", "default": "email_abuse.txt",
             "help": "账号文件(每行 email----password----abuse----ts)"},
            {"flag": "--limit", "type": "int", "default": 0, "help": "只跑前 N 个(0=全部)"},
            {"flag": "--concurrency", "type": "int", "default": 2, "help": "并发数"},
            {"flag": "--proxy-url", "type": "str", "default": "",
             "help": "HTTP GET 代理池地址(return_type=socks5)；留空读 .env OUTLOOK_PROXY_URL"},
            {"flag": "--proxy-file", "type": "str", "default": "", "help": "本地代理池文件(与 --proxy-url 二选一)"},
            {"flag": "--proxy", "type": "str", "default": "", "help": "单条代理(整浏览器走它)；优先级最高"},
            {"flag": "--headless", "type": "bool", "default": True, "help": "无头模式(abuse 风控重可关掉走有头)"},
            {"flag": "--max-press", "type": "int", "default": 5, "help": "按住最大次数"},
            {"flag": "--timeout", "type": "int", "default": 300, "help": "单账号超时(秒)"},
            {"flag": "--launch-stagger", "type": "float", "default": 3.0, "help": "浏览器启动错峰秒数(规避 XPCOM 文件锁)"},
            {"flag": "--log-level", "type": "choice", "default": "INFO",
             "choices": ["DEBUG", "INFO", "WARN", "PROD", "ERR"],
             "help": "日志等级"},
        ],
